...
>
  ...
  <button 
    className="flex items-center text-yellow-700 bg-white font-semibold cursor-pointer px-4 py-2 rounded-md border border-red-500 hover:bg-green-100 transition-all"
