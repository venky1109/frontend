...
const OrderOptions = () => {
  ...
  return (
    <div className="relative w-full flex flex-row items-center justify-center  gap-1">
      ...
      <div className="w-1/2 overflow-hidden bg-green-100 border border-green-900 p-2 rounded-xl shadow-md flex flex-col items-center justify-center">
     ...
     {/* Landline Call Banner */}
      <div className="w-1/2  overflow-hidden bg-amber-100 border border-amber-900 p-2 rounded-xl shadow-md flex flex-col items-center justify-center">
